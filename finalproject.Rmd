...
ggplotly(GDPP_hours,
         ...
         tooltip = c("text", 
                     ...
                     "y",
                     "City")) %>% 
layout(title = list(text = paste0('Gross Domestic Product per Capita by Country and Average Weekly Hours Worked',
                                    '<br>',
                                    '<sup>',
                                    'Data sourced from Kaggle and World Population Review',
                                    '</sup>')))
```
